...
namespace graphics {
	...
	static unsigned int to_gl_shader_type(Shader::Type type) {
		switch (type) {
		case Shader::Type::VERTEX:
			return GL_VERTEX_SHADER;
		case Shader::Type::FRAGMENT:
	...
	static unsigned int compile_shader(const Shader::Type type, const std::string& source_code) {
		GLCall(const unsigned int shader_id = glCreateShader(to_gl_shader_type(type)));
	...
	static unsigned int create_shader(const std::string& vertex_shader, const std::string& fragment_shader) {
		GLCall(const unsigned int program_id = glCreateProgram());
		const unsigned int vertex_shader_id = compile_shader(Shader::Type::VERTEX, vertex_shader);
		const unsigned int fragment_shader_id = compile_shader(Shader::Type::FRAGMENT, fragment_shader);
...
void Shader::set_uniform_2ui(const std::string name, unsigned int i0, unsigned int i1) 
{
...
void Shader::set_uniform_3ui(const std::string name, unsigned int i0, unsigned int i1, unsigned int i2) 
{
...
void Shader::set_uniform_4ui(const std::string name, unsigned int i0, unsigned int i1, unsigned int i2, unsigned int i3) 
{

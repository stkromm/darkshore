...
public:
    ...
    */
    ...
    /** Accept a hierarchical visit of the nodes in the TinyXML-2 DOM. Every node in the
    	...
    	This is essentially a SAX interface for TinyXML-2. (Note however it doesn't re-parse_tmx
...
public:
	...
	const XMLElement* begin() const
	{
		return NextSiblingElement();
	}

	const XMLElement* end() const 
	{
		return this->Parent()->LastChildElement();
	}

...
namespace tilemap
{
	class TileMapGridRenderView
	{
		...
		std::unique_ptr<ds::graphics::VertexBuffer> vertex_buffer_position;
		std::unique_ptr<ds::graphics::VertexBuffer> vertex_buffer_uvs;
		std::unique_ptr<ds::graphics::VertexBuffer> vertex_buffer_color;
		std::unique_ptr<ds::graphics::VertexArray> vertex_array;
		std::unique_ptr<ds::graphics::IndexBuffer> index_buffer;
		std::shared_ptr<ds::graphics::TiledTexture> tiled_texture;
	...
	public:
		...
		void draw(ds::graphics::Shader* shader) const;

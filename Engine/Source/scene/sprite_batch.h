...
namespace graphics
{
	...
	public:
		...
		uint32 push(const float interpolation, const ds::graphics::TexturePatch& texture_patch, const math::FVec2 position, const math::FVec2 extends, const uint32_t color)
		{
			// Enable texture

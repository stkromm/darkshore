...
namespace ds {
	namespace scene
	{
		...
		public:
			...
			uint32 push(const float interpolation, const ds::graphics::TexturePatch& texture_patch, const ds::FVec2 position, const ds::FVec2 extends, const uint32_t color)
			{
				// Enable texture
			...
			void flush()
			{
				...
				shader->bind();
				vertex_array->draw(*index_buffer);
		...
		public:
			...
			void submit(const float interpolation, const ds::graphics::TexturePatch& texture_patch, const ds::FVec2 position, const ds::FVec2 extends, const uint32_t color)
			{
				// Enable texture
				const uint32_t texture_id = texture_patch.texture->get_id();
				int texture_index = -1;
